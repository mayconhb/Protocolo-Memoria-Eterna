...
export const PRODUCTS: Product[] = [
  {
    ...
    category: 'Receta',
    image: '/protocolo_memoria_eterna_cover.png',
    isLocked: false,
    ...
    guideDetails: [
      {
        ...
        blocks: [
          { type: 'video_session', title: "Memory Pulse", duration: "8 min", frequency: "Gamma", videoUrl: "/attached_assets/2_1767827904922.mp4" },
